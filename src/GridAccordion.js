                                                ...
                                                <div key={i}>
                                                    <div className="box">
                                                        <div className="image fit">
                                                            <LazyLoadImage src={item.image.indexOf('http')>-1?item.image:process.env.PUBLIC_URL+"/images/"+item.image.split(".")[0]+this.props.jpgName} alt="" effect="blur"/>
                                                        </div>
                                                        <div className="content">
                                                            <header className="align-center">
                                                                <p>{item.tag}</p>
                                ...
                                this.props.arr.map((item,i)=>{
                                    ...
                                    {   
                                        ...
                                        if(item.subTitle===""||typeof item.subTitle==='undefined')
                                            this.htmlEle+='<li><h3 class="cbp-nttrigger">'+item.date+'</h3><div class="cbp-ntcontent"><p>'+item.title+'<br /><a href="'+item.link+'" target="_blank">'+item.link+'</a></p>';
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        if(this.lvl===2)
                                        {
                                            if(this.lastT!==item.title)
                                            {
                                                ...
                                                {
                                                    this.lvl=1;
                                                    this.htmlEle+= '</ul><p>'+item.title+'<br /><a href="'+item.link+'" target="_blank">'+item.link+'</a></p>';
                                                }
                                                else	
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                if(this.lastT!==item.title)
                                                    this.htmlEle+= '<p>'+item.title+'<br /><a href="'+item.link+'" target="_blank">'+item.link+'</a></p>';
                                                else
                                                    this.htmlEle+='<li><h4 class="cbp-nttrigger">'+item.title+'</h4><div class="cbp-ntcontent"><p><br /><a href="'+item.link+'" target="_blank">'+item.link+'</a></p>';
                                            }
                                            else
                                            {
